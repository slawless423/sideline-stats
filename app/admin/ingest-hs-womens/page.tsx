// app/admin/ingest-hs-womens/page.tsx
//
...
export default function IngestHsWomensPage() {
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      const res = await fetch('/api/admin/ingest-hs-womens', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ maxWidth: 900, margin: '0 auto', padding: '32px 24px', fontFamily: 'Outfit, system-ui, sans-serif', color: NAVY }}>
      <h1 style={{ fontSize: 28, fontWeight: 600, marginBottom: 8 }}>Ingest Box Score — Women&apos;s HS</h1>
      ...
      <textarea
        ...
        placeholder='{ "league": "17U EYBL", "season": "2026", "teams": [...] }'
        rows={20}
        style={{
          width: '100%',
          padding: '12px',
